...
class Talks(models.Model):
    ...
    to_user_id = models.ForeignKey(User, related_name="tid" ,on_delete=models.CASCADE)
    from_user_id = models.ForeignKey(User, related_name="fid" ,on_delete=models.CASCADE)
